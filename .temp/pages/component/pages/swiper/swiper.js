        ...
        <View className="components-page__body">
          <View className="components-page__body-example example">
            ...
            <View className="example-body">
              <Swiper slideMult="10" indicatorColor="#999" indicatorActiveColor="#333" current={current} duration={duration} interval={interval} circular={isCircular} autoplay={isAutoplay} indicatorDots={hasIndicatorDots} preMargin="20">
                <SwiperItem>
              ...
              <View className="slider-list">
                <View className="slider-list__item">
                  ...
                  <View className="slider-list__item-body">
                    <Slider showValue step={1} min={500} max={2000} value={duration} onChange={this.setDuration}></Slider>
                  </View>
                </View>
                <View className="slider-list__item">
                  <View className="slider-list__item-header">
                  ...
                  <View className="slider-list__item-body">
                    <Slider showValue step={1} min={2000} max={10000} value={this.state.interval} onChange={this.setInterval}></Slider>
                  </View>
                </View>
              </View>
            </View>
          ...
          <View className="components-page__body-example example">
            ...
            <View className="example-body">
              <Swiper slideMult="10" className="test-h" indicatorColor="#999" indicatorActiveColor="#333" vertical circular={verticalIsCircular} indicatorDots={verticalHasIndicatorDots} autoplay={verticalIsAutoplay} preMargin="20">
                <SwiperItem>
                  <View className="demo-text-1"></View>
                </SwiperItem>
                <SwiperItem>
