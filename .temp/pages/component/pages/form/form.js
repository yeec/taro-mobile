...
import { View, Text, Label, Radio, Checkbox, Slider, Input, Button, RadioGroup, Form, CheckboxGroup, Switch } from '@tarojs/components';
        ...
        <Form onSubmit={this.formSubmit} onReset={this.formReset}>
          <View className="components-page__body">
            ...
            <View className="components-page__body-example example">
              ...
              <View className="example-body">
                <RadioGroup className="example-body__radio-group" onChange={this.onRadioChange} name="radio">
                  ...
                  return <Label className="example-body__radio-group-item" for={item.key} key={item.key}>
            ...
            <View className="components-page__body-example example">
              ...
              <View className="example-body">
                <CheckboxGroup className="example-body__checkbox-group" onChange={this.onCheckChange} name="checkbox">
                  ...
                  return <Label className="example-body__checkbox-group-item" for={item.key} key={item.key}>
            ...
            <View className="components-page__body-example example">
              ...
              <View className="example-body">
                <Slider name="slider" value={this.state.sliderValue} showValue onChange={this.handleSliderChange} bingchanging={this.handleSliderChanging}></Slider>
              </View>
            </View>
